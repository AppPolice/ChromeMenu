...
- (id)initWithOwner:(CMMenu *)owner {
	...
	CMUnderlyingWindow *window = [[CMUnderlyingWindow alloc] initWithContentRect:rect defer:YES];
...
- (void)setBorderRadiuses:(NSArray *)radiuses {
	[(CMUnderlyingView *)[[self window] contentView] setBorderRadiuses:radiuses];
}
